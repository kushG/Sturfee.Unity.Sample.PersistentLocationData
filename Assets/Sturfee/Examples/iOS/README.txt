...
This scene represents how XRSession can be initialized for any iOS device. Notice the ProviderSet in SturfeeXRSession inspector is set to `Default/IOS Providers Set`.
