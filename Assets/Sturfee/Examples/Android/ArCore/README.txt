...
This scene represents how XRSession can be initialized with ArCore. Notice the ProviderSet in SturfeeXRSession inspector is set to `Custom/ArCore Provider Set`.
