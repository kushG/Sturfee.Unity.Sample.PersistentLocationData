...
namespace Sturfee.Unity.XR.Package.Templates
{
    ...
    {
        #region Faked Events
        public delegate void HandleLocalizationLoading();
        public static event HandleLocalizationLoading OnLocalizationLoading;
        public delegate void HandleLocalizationComplete();
        public static event HandleLocalizationComplete OnLocalizationComplete;
        #endregion
        ...
        private void Awake()
        {
            ...
            SturfeeEventManager.Instance.OnLocalizationComplete += OnHandleLocalizationComplete;
            SturfeeEventManager.Instance.OnLocalizationLoading += OnHandleLocalizationLoading;
        ...
        private void OnHandleLocalizationLoading()
        {
        ...
        private void OnHandleLocalizationComplete(Core.Constants.Enums.AlignmentStatus status)
        {
